(function(_, Backbone, APP) {
	...
	APP.Router = Backbone.Router.extend({
		...
		state: {
			...
			standalone: function(){ return (("standalone" in window.navigator) && window.navigator.standalone) || (typeof PhoneGap !="undefined" && !_.isUndefined(PhoneGap.env) && PhoneGap.env.app ) || ((typeof window.external != "undefined") && window.external.msIsSiteMode()); },
